...
outDir="${outDir:-"."}"
packagesList="${packagesList:-basesystem-minimal bash urpmi systemd initscripts termcap ncurses dhcp-client locales locales-en git-core htop iputils iproute2 nano squashfs-tools tar timezone passwd branding-configs-fresh rpm-build sudo fonts-ttf-freefont}"
